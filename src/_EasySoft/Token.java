 ...
 * La classe viene utilizzata dal metodo {@link utente.Utility_Utente#checkUtente(String, String)}
 ...
 * Una volta impostato l'hash password con quello dell'utente che vuole loggarsi nel sistema, la classe {@link _EasySoft.HomePage}
 ...
 * Inoltre la classe Ë stata modellata come classe singoletto, per poter permettere alla classe HomePage
 * di accedere allo stesso hash password impostato dall'utente che si Ë loggato.
 * @author matteo
 * @version 1.1
 */
public class Token {
	 ...
	 * L'oggetto pu√≤ essere istanziato solo all'interno della classe stessa.
	 */
	private Token() {}
	 ...
	 * Il metodo √® statico, quindi pu√≤ essere invocato senza istanziare la classe.
